...
| `rotation` | `0`       | A number between `0` and `360` that specifies the rotation angle in degrees for the camera feed. This is useful for cameras that are mounted sideways or upside down. The rotation is applied around the center of the image. When using `90` or `270` degree rotations, the container will automatically adjust to maintain proper aspect ratio.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
